      ...
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <form action="#" className="mt-8 grid grid-cols-6 gap-6">
          <div className="col-span-6 sm:col-span-3 ">
            <label htmlFor="username" className="block text-sm font-bold font-mono text-gray-700">
              Username
            </label>
          ...
          <div className="col-span-6 sm:col-span-3">
            <label htmlFor="upi" className="block text-sm font-bold font-mono text-gray-700"> UPI id </label>
          ...
          <div className="col-span-6">
            <label htmlFor="PhoneNo" className="block text-sm font-bold font-mono text-gray-700 shadow-inner"> Phone Number </label>
